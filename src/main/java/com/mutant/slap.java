...
public class slap {
  ...
  // (row, col) in grid[][]
  private static boolean search2D(char[][] grid, int row,
                                  int col, String word) {
  ...
  public static void main(String args[])
  {
    R = 3;
    C = 13;
    char[][] grid = {{'G','E','E','K','S','F','O','R','K','E','O','K','O'},
                     {'O','E','E','K','S','Q','S','Z','O','G','E','L','E'},
                     {'I','D','E','Q','A','P','R','A','C','T','I','C','P'}};
    patternSearch(grid, "LEO");
    System.out.println();
